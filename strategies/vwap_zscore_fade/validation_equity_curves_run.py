"""Run i.i.d. equity-curve bootstrap on the validation child."""
...
def run_validation_equity_curves() -> Path:
...
def build_equity_curves_report(
    *,
    ...
    equity_curves = monte_carlo_equity_curves(
        realized_r,
        n_iter,
        random_seed,
    )
    ...
    return {
        "run_type": "validation_equity_curves",
...
def write_equity_curve_artifacts(
    *,
    output_dir: str | Path,
    equity_curves_report: dict[str, Any],
    run_config: dict[str, Any],
) -> None:
    output_path = Path(output_dir)
    output_path.mkdir(parents=True, exist_ok=False)
    _write_json(output_path / "equity_curves_report.json", equity_curves_report)
...
def _output_dir() -> Path:
    ...
    return OUTPUT_ROOT / f"validation_equity_curves_{timestamp}"
...
if __name__ == "__main__":
    print(run_validation_equity_curves())
